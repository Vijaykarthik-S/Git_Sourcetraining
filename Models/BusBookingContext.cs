...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=LAPTOP-7PTI9LUL;Database=BusBooking;Integrated Security=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Booking>(entity =>
            {
                ...
                entity.HasOne(d => d.Route)
                    ...
                    .HasConstraintName("FK__Bookings__RouteI__4222D4EF");
            ...
            modelBuilder.Entity<BusOperator>(entity =>
            {
                entity.HasKey(e => e.OperatorId)
                    .HasName("PK__BusOpera__7BB12FAE8B39343E");
                ...
                entity.HasOne(d => d.Bus)
                    ...
                    .HasConstraintName("FK__BusOperat__BusID__45F365D3");
            });

            modelBuilder.Entity<BusRoute>(entity =>
            {
                entity.HasKey(e => e.RouteId)
                    .HasName("PK__BusRoute__80979B4D46EABBC6");
                ...
                entity.HasOne(d => d.Bus)
                    ...
                    .HasForeignKey(d => d.BusId)
                    .HasConstraintName("FK__BusRoutes__BusId__3C69FB99");
            });
