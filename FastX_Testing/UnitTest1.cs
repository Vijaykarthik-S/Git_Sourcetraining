...
namespace FastX_Ticket_Booking_System.Tests
{
    ...
    public class BusBookingTests
    {
        ...
        public void AddBus_Testing()
        {
            ...
            Assert.That(result, Is.EqualTo(1), "Bus was not added successfully.");
        }
        ...
        public void UpdateBus_Testing()
        {
            ...
            Assert.That(result, Is.EqualTo("Success"), "Bus was not updated successfully.");
        }
        ...
        public void DeleteBus_Testing()
        {
            ...
            Assert.That(result, Is.EqualTo("Success"), "Bus was not deleted successfully.");
        }
        ...
        public void AddBooking_Test()
        {
            ...
            Assert.That(result, Is.EqualTo(1), "Booking was not added successfully.");
        }
        ...
        public void UpdateBooking_Test()
        {
            ...
            Assert.That(result, Is.EqualTo("Success"), "Booking was not updated successfully.");
        }
        ...
        public void DeleteBooking_Test()
        {
            ...
            Assert.That(result, Is.EqualTo("Success"), "Booking was not deleted successfully.");
        }
        ...
        public void AddUser_Test()
        {
            ...
            Assert.That(result, Is.EqualTo(1), "User was not added successfully.");
        }
        ...
        public void UpdateAdmin_Test(int id)
        {
            ...
            Assert.That(result, Is.EqualTo("Success"), "User is not updated successfully.");
        }
        ...
        public void DeleteAdmin_Test()
        {
            ...
            Assert.That(result, Is.EqualTo("Success"), "User is not deleted successfully.");
        }
    }
}
