...
INSERT INTO BusRoutes (SourcePoint, Destination, BusId, DepartureTime, ArrivalTime) VALUES
...
INSERT INTO Bookings (UserId, RouteId, NumberofSeats, TotalPrice, BookingDate, BookingStatus) VALUES
(1, 1, 2, 1200.00, GETDATE(),'Booked'),
(2, 2, 1, 500.00, GETDATE(),'Booked'),
(3, 3, 3, 2100.00, GETDATE(),'Booked'),
(4, 4, 2, 1300.00, GETDATE(),'Booked'),
(5, 5, 1, 700.00, GETDATE(),'Booked'),
(6, 6, 4, 3200.00, GETDATE(),'Booked'),
(7, 7, 1, 600.00, GETDATE(),'Booked'),
(8, 8, 2, 1600.00, GETDATE(),'Booked'),
(9, 9, 3, 2100.00, GETDATE(),'Booked'),
(10, 10, 1, 800.00, GETDATE(),'Booked');
