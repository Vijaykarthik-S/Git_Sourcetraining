...
namespace FastX_Ticket_Booking_System.Tests
{
    ...
    public class BusBookingTests
    {
        ...
        public void AddUser_Test()
        {
            ...
            Assert.AreEqual(1, result, "User was not added successfully.");
        }
        ...
        public void UpdateAdmin_Test(int id)
        {
            ...
            Assert.AreEqual("Success", result, "User was not updated successfully.");
        }
        ...
        public void DeleteAdmin_Test()
        {
            ...
            Assert.AreEqual("Success", result, "User was not deleted successfully.");
        }
    }
}
